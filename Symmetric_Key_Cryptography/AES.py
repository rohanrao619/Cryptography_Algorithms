...
Xtime = [[0x02, 0x03, 0x01, 0x01], [0x01, 0x02, 0x03, 0x01], [0x01, 0x01, 0x02, 0x03], [0x03, 0x01, 0x01, 0x02]]
class AES:
    def __init__(self, master_key):
        self.generate_key(master_key)
        
    ## Key Generation

    def generate_key(self, master_key):
    ...
    def encrypt(self, plaintext):
        ...
        self.sub_byte(self.plain_state)
...
master_key=str(input(' Enter 128-bit Master Key : '))   # Example : 2b7e151628aed2a6abf7158809cf4f3c
x=AES(int(master_key,16))
plain=str(input(' Enter Plain Text : '))  
cipher=hex(x.encrypt(int(plain,16)))         # Example : 3925841d02dc09fbdc118597196a0b32
print(' Cipher text : '+cipher)
decipher=hex(x.decrypt(int(cipher,16)))
